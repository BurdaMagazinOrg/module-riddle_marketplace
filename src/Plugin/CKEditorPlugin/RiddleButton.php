...
/**
 * @file
 * Definition of \Drupal\riddle\Plugin\CKEditorPlugin\RiddleButton.
 */

namespace Drupal\riddle\Plugin\CKEditorPlugin;
...
class RiddleButton extends CKEditorPluginBase implements CKEditorPluginInterface, CKEditorPluginButtonsInterface {
   ...
   */
  function getFile() {
    return drupal_get_path('module', 'riddle') . '/editor_plugin.js';
  }
  ...
  public function getConfig(Editor $editor) {
    ...
    $config = \Drupal::service('config.factory')->getEditable('riddle.settings');
